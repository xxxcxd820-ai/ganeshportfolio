...
const PROJECTS = [
  ...
  {
  id: "healthyhub-health-platform",
  title: "HealthyHub — Preventive Care & Health Tracking Ecosystem",
  category: "HealthTech & Telehealth",
  year: "2024",
  desc: "An end-to-end holistic wellness and medical consultation mobile interface featuring personalized habit monitoring, vital telemetrics, and frictionless specialist appointment booking.",
  image: "/assets/healthyhub-hero.png", // Nee screenshot asset path ikkada replace cheyyi
  tags: ["Figma", "UI/UX Design", "Design Systems", "Telehealth", "Mobile App"],
  liveUrl: "https://www.figma.com/design/TY1tlWppyNqqV3HDMs2hWX/HealthyHub?node-id=0-1&p=f",
  githubUrl: "https://www.figma.com/design/TY1tlWppyNqqV3HDMs2hWX/HealthyHub?node-id=0-1&p=f",
  stats: [
    { label: "Daily Active Retention", val: "72%" },
    { label: "Booking Drop-off", val: "-38%" },
    { label: "WCAG AA Adherence", val: "100%" },
  ],
},
  {
